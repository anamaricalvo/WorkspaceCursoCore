...
public class MainColecciones {
	...
	public static void main(String[] args) {
		...
		//si usáramos lo de arriba daría error porque la lista de colecciones no sirve para primitivos. si queremos crear un array de enteros debemos de usar su correrspondiente tipo wrapper (envoltorio)
		...
		Integer entero2 = 5;//esto se llama autoboxing (convierte el primitivo en objeto. Es decir, la línea 38 hace lo mismo que la 37, pero más "corto"
